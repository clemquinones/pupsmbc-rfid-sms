...
Public Class StudentLogRecords
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CampusSSACS_RFID_SMS.StudentLogRecords.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudentLogRecords
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudentLogRecords = New StudentLogRecords
        rpt.Site = Me.Site
        Return rpt
    End Function
