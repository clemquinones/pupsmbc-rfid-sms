@echo off & color 0a
set ACTION=RESTORE
set DESTINATIONDIR=C:\Users\PEANUT BRITTLE\Desktop\_BACK_UP_
set DESTINATIONFILENAME=db_campus_back_up.SQL
set SOURCE=C:\Users\PEANUT BRITTLE\Desktop\_BACK_UP_\db_campus_back_up.SQL
...
if not exist "%MYSQL_PATH%" ( msg * /w /time:15 Cannot continue back-up session. File missing '%MYSQL_PATH%.' & exit)
