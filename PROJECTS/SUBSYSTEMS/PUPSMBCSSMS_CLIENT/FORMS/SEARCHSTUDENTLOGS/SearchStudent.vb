...
#Region "FRMSEARCH"
    ...
    Private Sub btnAdvanced_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdvanced.Click
        If btnAdvanced.Text.Contains(">>") Then btnAdvanced.Text = "<< Hide" : Me.Width = 655 Else btnAdvanced.Text = "Advanced >>" : Me.Width = 378 : toHL(txtKey)
    End Sub
...
#End Region
    ...
    Public Sub DisplayResult(Optional ByVal sql As String = Nothing)
        ...
        If lvResult.Items.Count <= 0 Then : selected = -1
            lvResult.Items.Add("No items...").SubItems.Add("No items...") : pbPic.Image = No_Picture
        Else
    ...
    Private Sub btnFilter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFilter.Click
        ...
        ElseIf cmbLog.Enabled = True Then
            If cmbLog.Text.Contains("Today") Then
                DateStart = " and m.datetime between '" & Format(sDT, "yyyy/MM/dd") & " " & TimeStart & "'"
                DateEnd = " and '" & Format(sDT, "yyyy/MM/dd") & " " & TimeEnd & "'"
            ElseIf cmbLog.Text.Contains("Yesterday") Then
                DateStart = " and m.datetime between '" & Format(sDT, "yyyy/MM") & "/" & (CInt(Format(sDT, "dd")) - 1) & " " & TimeStart & "'"
                DateEnd = " and '" & Format(sDT, "yyyy/MM") & "/" & (CInt(Format(sDT, "dd")) - 1) & " " & TimeEnd & "'"
            ElseIf cmbLog.Text.Contains("This Week") Then
                If Format(sDT, "dd") - sDT.DayOfWeek <= 0 Then
                    DateStart = " and m.datetime between '" & Format("yyyy") & "/" & Format(sDT, "MM") & "/01" & " " & TimeStart & "'"
                Else
                    DateStart = " and m.datetime between '" & Format("yyyy") & "/" & Format(sDT, "MM") & "/" & (Format(sDT, "dd") - sDT.DayOfWeek) & " " & TimeStart & "'"
                End If
                DateEnd = " and '" & Format(sDT, "yyyy/MM/dd") & " " & TimeEnd & "'"
